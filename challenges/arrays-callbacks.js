...
*/
function add(a, b) { //Used arrow functions for this in the stretch
  return a + b;
}
function multiply(a, b) { //Used arrow functions for this in the stretch
  return a * b;
}
function greeting(a, b) { //Used arrow functions for this in the stretch
...
// let greeting = (a, b) => { return `Hello ${a} ${b}, nice to meet you!` };
